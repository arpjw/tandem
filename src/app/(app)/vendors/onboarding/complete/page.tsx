...
function OnboardingCompleteContent() {
  ...
  // const industry = searchParams.get('industry'); // Could use this for a custom message
    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-background p-4 sm:p-6 lg:p-8">
      <Card className="w-full max-w-md text-center shadow-xl">
        ...
        <CardContent className="space-y-4">
          ...
          <CardDescription>
            You can now explore subcontracting opportunities and further enhance your vendor profile.
          </CardDescription>
        </CardContent>
        <CardFooter className="flex flex-col space-y-3">
          ...
          <Button variant="outline" asChild className="w-full">
            <Link href="/vendors/new">Manage Your Vendor Profile</Link>
          </Button>
        </CardFooter>
      </Card>
