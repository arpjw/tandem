...
function DocumentUploadContent() {
  ...
  const handleContinue = () => {
    if (industry) {
      router.push(`/suppliers/onboarding/complete?industry=${encodeURIComponent(industry)}&verified=true`); // Path Updated
    } else {
      router.push('/suppliers/onboarding/complete?verified=true'); // Path Updated
    }
  };
        ...
        <Card className="w-full max-w-lg text-center">
          ...
          <CardFooter>
            <Button asChild className="w-full">
              <Link href="/suppliers/onboarding/industry"> {/* Path Updated */}
